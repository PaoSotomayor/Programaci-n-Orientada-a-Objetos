...
Tendremos los 3 coeficientes como atributos, llamémosles a, b y c. Hay que insertar estos 3 valores para construir el 
objeto a través de un método constructor. Luego, las operaciones que se podrán realizar son las siguientes:
- Método getDiscriminante(): devuelve el valor del discriminante (double). El discriminante tiene la siguiente formula: 
(b^2)-4*a*c
 ...
 */
public class Eje03ExtraPOO_Raices {
    ...
    public static void main(String[] args) {
       ...
       service.getDiscriminante(raiz);
       service.tieneRaices(raiz);
       service.obtenerRaices(raiz);
       service.obtenerRaiz(raiz);
       //service.calcular(raiz);
    }
}
