...
public class PersonaSServicio {
    ...
    public PersonaS crearPersona() {
        ...
        persona2.setEdad(fecha);
        return persona2;
    }

    public int calcularEdad(PersonaS persona2 ) {
        int edad = 0;
        Date fechaActual = new Date();
        edad = fechaActual.getYear() - persona2.getEdad().getYear();
        System.out.println(fechaActual.getYear() - persona2.getEdad().getYear() + " años");
        return edad;
    }
    ...
    public void mostrarPersona (PersonaS persona2){       
